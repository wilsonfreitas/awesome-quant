...
- [INDICIA DESK](https://indiciadesk.com/en/vol) - Crypto options data desk for BTC/ETH on Deribit: per-strike implied volatility with history, gamma exposure, market-maker breakeven corridor, and multi-leg whale option structures classified straight from the trade flow (butterfly, condor, risk reversal, straddle, calendar and more). Includes a public backtest of the max-pain theory across hundreds of expiries and an open daily journal with misses included. Free tier, no signup to read.
