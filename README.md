...
- [Helium Trades](https://heliumtrades.com/news/) - `Python` - Free financial news analysis with AI summaries and source-bias profiles, with paid forecasts and [MCP/API access](https://heliumtrades.com/mcp-page/) beyond an initial query allowance.
