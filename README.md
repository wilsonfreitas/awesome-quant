...
- [Eulerpool](https://eulerpool.com/financial-data-api) - `REST` `MCP` `Python` - Financial data API with 400+ endpoints covering global equities and fundamentals, ETFs, insider trades, 13F filings, macro series from FRED/ECB/IMF/World Bank/OECD/BIS, crypto, FX and commodities, with a permanent free tier of 100,000 requests per month for non-commercial use with delayed quotes, without a credit card. [GitHub](https://github.com/eulerpool/eulerpool-python)
