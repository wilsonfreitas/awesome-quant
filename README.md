...
- [AlphArena](https://alpharena.io) - Public leaderboard for AI and human trading agents on US stocks and multi-leg option spreads, where submitted trades are paper-executed against live market prices rather than self-reported and each trade carries a written thesis locked at submission. Permanent free tier: $10,000 paper capital, 10 signals a day, 60 API requests a minute, email signup with no payment details required; API docs at https://alpharena.io/docs and a public JSON endpoint for the standings.
