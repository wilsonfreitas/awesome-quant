...
## Trading & Backtesting
- [signalcraft-labs-engineering-notes](https://github.com/yfjelley/signalcraft-labs-engineering-notes) - `JavaScript` - Dependency-free dry-run demos of live-trading plumbing: TradingView-style webhook de-duplication with a pre-trade risk gate, broker order reconciliation after a restart, and an IBKR session refresher, each runnable with plain Node.js.
