...
- [Quant v11 Ensemble 6-Alpha Specs](https://huggingface.co/datasets/neogenesislab/quant-v11-ensemble-6alpha-specs-2026) - `Python` `Node.js` - Open research dataset (CC-BY-4.0) shipping 375 sections from a 6-alpha quantitative trading ensemble: A1 Liquidation Cascade, A2 Mean Reversion OU, A3 Extreme Funding Reversal, A4 Macro Event Bracket, A5 Funding/Basis Harvest, A6 Alt MM. Documented 9-Layer Kill Switch wiring (Order Rate Cap, Correlation Killer, Stablecoin Depeg Guard, Funding Spike Guard, etc) with sub-100ms anomaly response. **Honest scoping**: PAPER-mode only until 14-day Sharpe >= 1.2 AND DSR (Deflated Sharpe Ratio) >= 0.5 graduation gate is cleared. DOI: [10.5281/zenodo.20018487](https://doi.org/10.5281/zenodo.20018487).
