...
- [Convex Lake](https://convexlake.com) - Batch and real-time trade, order-book, and volatility-surface data across Kalshi, Polymarket, Predict.fun, Limitless, Deribit, and Binance options in one API. Free academic-research tier available on request.
