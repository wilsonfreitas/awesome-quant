...
- [Tickwind](https://www.tickwind.com) - Free US stock research web app built on SEC EDGAR data: 10-year XBRL fundamentals and financial history, factor scorecards with Piotroski F-Score and Altman Z-Score, Form 4 insider activity, 13F superinvestor tracking, congressional trades, unusual options activity and max pain (Cboe delayed), N-PORT ETF holdings, and 10-K/10-Q filing diffs.
