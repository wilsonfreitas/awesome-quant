...
- [DataSinking](https://datasink.ing) - Full-text financial reports (China A-share, Korea, Japan) as clean Markdown
  via REST API and MCP server, with chapter-level access for RAG. Free tier available.
