...
- [GreeksLab](https://greekslab.launchyard.app) - `JavaScript` - Free options Greeks calculator covering Delta, Gamma, Theta, Vega, Rho, implied volatility, multi-leg strategy builder, and P&L charts. [GitHub](https://github.com/greekslab/greekslab)
