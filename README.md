...
- [Convex Lake](https://convexlake.com) - API for batch and real-time prediction-market and crypto-derivatives data; permanent free access provides a one-day sample from one venue at 60 requests per minute, with paid plans for broader access.
