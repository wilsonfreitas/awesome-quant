...
- [TalVal Research](https://talval.com) - `MCP` `Web` - Fundamental research on ~960 US and European companies computed from their filings, with fair-value estimates, valuation classifications, quality and safety scores, and superinvestor 13F portfolios; permanent free plan without payment information (3 full company reports a day, 13F tracking, 1 PDF export a month) and an anonymous remote MCP server.
