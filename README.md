...
- [Edgrapi](https://edgrapi.com) - `REST` `MCP` - SEC EDGAR data as JSON: Form 4 insider trades, 8-K events, 13F holdings aggregated per position, Schedule 13D/G stakes and XBRL fundamentals, over REST and a hosted MCP server, with a permanent free tier of 100 credits/month (1-5 credits per call) and no card required. [GitHub](https://github.com/paperandbeyond23-gif/edgrapi-python)
