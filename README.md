...
### Data Sources
- [VertData](https://vertdata.com) - Real-time SEC filings, insider transactions, earnings signals, and macro data for hedge funds, family offices, and registered investment advisors.
