...
- [Bargo Congress Trades API](https://www.bargo.ai/free-apis/congress) - `Python` `TypeScript` `MCP` - Free REST API and MCP server for normalized U.S. House and Senate STOCK Act securities transaction disclosures, with official Python and TypeScript clients. [GitHub](https://github.com/bargo-ai/bargo-free-api-packages)
