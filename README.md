...
- - [AI Quant Builder](https://github.com/haysung1191-eng/ai-quant-builder) - `Python` - Failure-oriented reliability audits for quant research: data leakage, out-of-sample validation, cost modeling, and order-to-fill lineage tracing across 24 checks.
