...
- [bykaranteli-mcp](https://github.com/bykarantelicom/bykaranteli-mcp) - `TypeScript` `MCP` - MCP server providing 34 read-only crypto derivatives data tools through a free public API, runnable locally or via a hosted endpoint without an API key. [Website](https://bykaranteli.com/developers)
