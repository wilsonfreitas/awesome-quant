...
- [Little Bird Trading](https://littlebirdtrading.com) - Daily support, resistance and pivot levels for SPY, ES, QQQ, NQ, ASX 200/SPI and NIFTY 50 published as JSON, with a permanent free tier covering the prior session that needs no account or API key, and a $29.99/month tier adding the next session's levels before the open.
