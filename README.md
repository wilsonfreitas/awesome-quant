...
- [KLinePic](https://klinepic.com/) - `TypeScript` - Converts broker and exchange trade records into annotated candlestick review charts with buy/sell markers, batch PNG/ZIP export, and an Agent API. [GitHub](https://github.com/sher1096/klinepic-agent-api-examples)
