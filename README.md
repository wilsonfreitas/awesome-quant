...
- [SIGNUM HQ](https://signumhq.com) - US equity options and dark pool analytics covering options flow, dark pool volume share, gamma exposure, max pain, open-interest change and AI-generated market briefings, with formula write-ups in a public Learn section. Free tier: 13-F institutional holdings lookup, one sector report and 60-second data refresh, no payment details required.
