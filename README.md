...
- [TraderSpy](https://traderspy.app) - `MCP` - AI-generated crypto futures signals with realized outcomes, top-trader positions on Binance, Hyperliquid, Bybit and OKX, indicators, funding rates, open interest, a screener and condition backtests through a read-only hosted MCP server, with a permanent free tier of 300 tool calls per day and positions delayed 15 minutes, without a credit card. [GitHub](https://github.com/target1m/traderspy-mcp)
