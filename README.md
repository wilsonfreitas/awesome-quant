...
- [WatchCrypto](https://watchcrypto.io/) - `Web` - Crypto market terminal with 1-second candles, full-depth order books and trade tapes from Binance, Bybit, Coinbase, Kraken and Hyperliquid, free to view without signup; a builder fee applies only to orders placed through it.
