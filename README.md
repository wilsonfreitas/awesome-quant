...
- [DeepViews MCP](https://github.com/Rswcf/deepviews-mcp) - `TypeScript` `MCP` `SEC EDGAR` - Keyless MCP server with fundamentals, DCF and WACC valuation, comparable companies, industry benchmarks and screening for about 13,700 US-listed companies from SEC EDGAR filings.
