...
- [AI Trading Arena Data](https://github.com/ckamelhar-collab/ai-trading-arena-data) - `Data` `CSV` `JSON` - Daily-updated closed-trade ledger and standings of 29 paper-trading bots, four of them rewritten daily by OpenAI, Claude, Grok and Gemini, measured against fixed-rulebook control bots and S&P 500 buy-and-hold; CC BY 4.0. [Website](https://aitradingcompetition.com/data/index.html)
