...
- [Market Intelligence Platform](https://github.com/faot84/market-intelligence-platform) - `Python` `SQLite` `AI` - Local-first market and portfolio research environment with immutable observations, scoring, news normalization, mock AI analysis, review alerts, automation, health checks, and a read-only dashboard.
