...
- [AutoHypothesis](https://github.com/arteemg/AutoHypothesis) - `Python` - An agentic framework for autonomous quantitative finance hypothesis research and discovery.
