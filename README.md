...
* [BDE Score™](https://github.com/hbhqq9/bde-score) - 多市场（美股/港股/A股）多因子量化评分 MCP Server，5因子评分体系（动量/均值回归/成交量/波动率/趋势），覆盖73支股票，支持x402微支付（$0.01/次），符合EU AI Act Art.50透明度要求。
