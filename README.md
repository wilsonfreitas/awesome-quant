...
- [AIStockWire Congress Trades](https://aistockwire.com/capitol) - Free congressional STOCK Act trade disclosures with per-trade links to House Clerk and Senate eFD filings, per-member 12-month returns versus SPY with a published methodology, and CSV downloads under CC BY 4.0, without signup.
