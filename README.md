...
- [OTCharts](https://otcharts.com) - `Python` `REST` - Market data for the OTC books of four binary options brokers (Pocket Option, Quotex, IQ Option, BinoDex) and institutional spot FX, as candles and server-sent tick streams, with a permanent free tier of five instruments per book, 1,000 requests per day and one live stream, without payment information. [GitHub](https://github.com/otcharts/otcharts-python)
