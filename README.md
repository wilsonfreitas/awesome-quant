...
- [easy-stock](https://github.com/jundizhou/easy-stock) - `Go` `React` `A-shares` - Local-first AI research workbench for China A-shares: unified market overview, theme radar, limit-up ladder and sentiment-cycle analysis, AI stock reports, portfolio inspection, and agent-based collection of post-market commentary with evidence tracing.
