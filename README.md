...
- [Microverse Systems](https://microversesystems.com) - `C++` - Real-time L2 order book data from 21 crypto exchanges. Sub-millisecond C++ infrastructure with WebSocket API. Free.
