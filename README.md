...
- [free-crypto-price-api](https://github.com/OzorOwn/free-crypto-price-api) - Real-time prices for 275+ crypto assets via Hyperliquid. No authentication, no rate limits, free forever. Python/Node.js/curl examples included.
