...
- [risktools](https://github.com/bbcho/risktools-dev) - Risk tools for use within the crude and crude products trading with partial implementation of R's PerformanceAnalytics.
